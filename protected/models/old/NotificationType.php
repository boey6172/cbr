...
/**
 * This is the model class for table "lib_notification_type".
 *
 * The followings are the available columns in table 'lib_notification_type':
...
class NotificationType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('notification_type_id, description', 'safe', 'on'=>'search'),
		);
	}
