...
<div class="row">
	<div class="col-md-4">
		<center class="well">
			<img src=<?php echo ($vm->driver->picture != '') ? $vm->driver->picture : "./images/user.png" ?> width="125" height="125" title="Profile Picture" alt="" id="profile_pic"><br><br>
			<label class="btn btn-primary">
	            <span class="fa fa-camera fa-lg"></span> Browse&hellip; <input type="file" id="file" style="display: none;">
	        </label>
		</center>
		<?php
			echo $form->hiddenField($vm->driver, 'picture', array('id'=>'img_uri'));
		?>
	</div>
	<div class="col-md-8">
		<?php
